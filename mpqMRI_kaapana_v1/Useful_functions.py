...
Description:
    This python script contains mutiple functions which use FSL, SPM and other modalities for 
    carrying out different operations on Nifti files like coregistration, normalization etc...
"""
import subprocess
import os
import shutil
