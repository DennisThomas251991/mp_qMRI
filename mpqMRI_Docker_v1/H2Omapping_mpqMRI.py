...
class H2O_map_mpqMRI():
    ...
    def run(self):
        ...
        M0_T1_biascorr_path = os.path.join(self.dst1, 'M0_T1_biascorr.nii.gz')
        ...
        M0_T1_T2s_biascorr_path = os.path.join(self.dst1, 'M0_T1_T2s_biascorr.nii.gz')
        ...
        CSF_calib_path = os.path.join(self.dst1, 'CSF_calib.nii.gz')
        nib.save(CSF_calib_nii, CSF_calib_path)
        # Problem detected: CSF_Calib empty 
        ...
        H2O_path = os.path.join(self.dst1, 'H2O.nii.gz')
        ...
        M0_T1_T2s_biascorr_path = os.path.join(self.dst1, 'M0_T1_T2s_biascorr_CSFT1mod.nii.gz')
        ...
        H2O_path = os.path.join(self.dst1, 'H2O_CSFT1mod.nii.gz')
    ...
    def T1_correction(self):
        ...
        M0_T1corr_path = self.dst1 + '/' + 'M0_T1corr.nii.gz'
    ...
    def Calc_CSF_calibration_factor(self):
        ...
        M0_T1corr = gre1/SF_map
        # print('M0_T1corr', M0_T1corr) NaaNs and Infs 
        if self.arguments.Bias_field_corr_method == 'SPM':
